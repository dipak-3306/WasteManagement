...
<head>
    ...
    <title>View Raised Status </title>
</head>
        ...
        <div class="flex flex-1">
            ...
            <aside id="sidebar" class="bg-side-nav w-1/2 md:w-1/6 lg:w-1/6 border-r border-side-nav hidden md:block lg:block">
                ...
                <ul class="list-reset flex flex-col">
                    ...
                    <a href="dashboard.html" class="hvr-shutter-in-horizontal">Go To Home</a>
                                ...
                                <table class="table-responsive w-full rounded">
                                    <thead>
                                      <tr>
                                        ...
                                        <th class="border w-1/6 px-4 py-2">Approve</th>
...
<%
	...
	try
	{
		...
		PreparedStatement ps1 = obj.prepareStatement("select * from cnd ");
...
%>
		...
		<tr>
			...
			<td><a href ="approved.jsp?id=<%=rs1.getInt("id")%>">Approve</a></td>
			<td><a href ="ShowImage.jsp?id=<%=rs1.getInt("id")%>">ShowImage</a></td>
